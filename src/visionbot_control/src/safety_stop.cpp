    ...
    cmd_vel_multiplier_{0.25}
{
  ...
  cmd_vel_raw_sub_ = create_subscription<geometry_msgs::msg::Twist>(
    cmd_vel_raw_topic,
    10,
    std::bind(&SafetyStopNode::cmd_vel_raw_callback, this, std::placeholders::_1));
...
void SafetyStopNode::cmd_vel_raw_callback(const geometry_msgs::msg::Twist::SharedPtr msg)
{
  if (!laser_scan_) {
  ...
  state_ = determine_state(laser_scan_);
...
SafetyStopState SafetyStopNode::determine_state(const sensor_msgs::msg::LaserScan::SharedPtr laser_scan)
{
